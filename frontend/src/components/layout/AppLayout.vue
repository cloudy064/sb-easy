  ...
  <div class="app-layout">
    <aside class="sidebar" :class="{ open: sidebarOpen }">
      ...
      <nav class="sidebar-nav">
        ...
        <router-link to="/server-logs" class="nav-item" active-class="active">
          <svg class="nav-icon" width="18" height="18" viewBox="0 0 18 18" fill="none" stroke="currentColor" stroke-width="1.6">
...
.sidebar {
  ...
  box-shadow: 4px 0 12px var(--nm-card-dark), -2px 0 8px var(--nm-card-light);
  display: flex;
...
.sidebar-brand {
  ...
  border-image: linear-gradient(to right, transparent, var(--nm-card-dark), transparent) 1;
  flex-shrink: 0;
}
